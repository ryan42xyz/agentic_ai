...
description: Extract clean, high-fidelity article content from URLs (blogs, technical posts, tutorials) by removing ads, navigation, and UI clutter. Produces a canonical raw text for downstream processing.
allowed-tools: Bash,Write
---

# Article Extractor

This skill extracts the main content from web articles and blog posts, removing navigation, ads, newsletter signups, and other UI noise.  
It produces a **maximum-fidelity canonical text** that preserves the author's original wording and structure.

This skill performs **no semantic judgment**.
...
- Provides an article or blog URL and wants the content saved
- Asks to extract or download an article without clutter
- Wants a clean text version of a technical post for further processing
- Needs a canonical source before summarization or distillation

---

## Core Responsibility

- Normalize external web content into a **clean, readable, raw article**
- Preserve original structure and phrasing as much as possible
- Serve as the **single source of truth** for downstream skills
...
- Remove explanations or examples written by the author
- Compress or summarize ideas
...
1. Detect available extraction tools
2. Extract article using the best available method
3. Remove UI-level noise only
4. Save result to file using article title
5. Show preview for verification
...
- Full author text
- No ads, navigation, or UI elements
...
- A human reader can reconstruct the original article logic
- No semantic information is lost
- Output is suitable for long-term archival or downstream processing
...
Ask if needed:
- "Would you like me to distill this article into a high-density version?" (if using core-distiller skill)
